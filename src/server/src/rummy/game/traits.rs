...
/// This trait implements game initialization.
pub trait GameInit {
    ...
    /// Resets all players,
    /// and deals active players the configured amount of cards.
    /// 
...
/// This trait implements basic Rummy player actions,
/// which can be taken during their turn.
...
/// This trait implements administrative actions not related to the gameflow itself.
pub trait GameAdmin {
